      ...
      >
        <div>
          ...
          <nav className="flex flex-col gap-5">
            <button className="flex items-center gap-3 px-3 py-2 rounded hover:bg-amber-500 hover:text-white transition" onClick={() => navigate("/admin/userlist")}>
              <FaUsers className="w-6 h-6" /> Users
            </button>
            <button className="flex items-center gap-3 px-3 py-2 rounded hover:bg-amber-500 hover:text-white transition" onClick={() => navigate("/admin/allproducts")}>
              <FaBoxOpen className="w-6 h-6" /> Products
            </button>
            <button className="flex items-center gap-3 px-3 py-2 rounded hover:bg-amber-500 hover:text-white transition" onClick={() => navigate("/admin/userorder")}>
